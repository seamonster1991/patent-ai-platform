...
export default function MarketAnalysisReport({ 
  ...
  if (loading) {
    return (
      <ReportLoadingState
        title="기술/시장 분석 리포트"
        description="AI가 특허 기술의 시장성과 사업화 가능성을 분석합니다"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                AI가 특허 기술의 시장성과 사업화 가능성을 분석합니다
              </p>
            </div>
          </div>
        </div>

        <Card className="border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
          <CardContent className="flex flex-col items-center justify-center py-16">
            <div className="relative mb-6">
              ...
              <FileText className="relative w-16 h-16 text-blue-600 dark:text-blue-400" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              리포트를 생성해주세요
            </h3>
            <p className="text-gray-600 dark:text-gray-400 text-center max-w-md mb-6">
              AI가 이 특허의 시장성과 사업화 가능성을 분석하여 전문적인 리포트를 생성합니다.
            </p>
            <Button 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-3 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 rounded-xl shadow-sm">
      ...
      <div className="space-y-6">
        {reportData.sections.map((section, index) => (
          <Card key={index} className="shadow-sm hover:shadow-lg transition-all duration-300 border-l-4 border-l-blue-500">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                {section.content.split('\n').map((paragraph, pIndex) => {
                    ...
                    return (
                      <p key={pIndex} className="mb-4 leading-relaxed">
                        {parts.map((part, partIndex) => 
                          partIndex % 2 === 1 ? (
                            <strong key={partIndex} className="font-semibold text-blue-900 dark:text-blue-100 bg-blue-50 dark:bg-blue-900/30 px-1 rounded">
                              {part}
                            </strong>
                          ) : (
                            part
                  ...
                  if (paragraph.trim().startsWith('-') || paragraph.trim().startsWith('•')) {
                    return (
                      <div key={pIndex} className="flex items-start gap-3 mb-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
