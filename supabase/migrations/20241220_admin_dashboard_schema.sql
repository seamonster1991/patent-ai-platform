...
CREATE INDEX IF NOT EXISTS idx_system_messages_active ON system_messages(is_active, start_date, end_date);
CREATE INDEX IF NOT EXISTS idx_user_feedback_status ON user_feedback(status);
CREATE INDEX IF NOT EXISTS idx_user_feedback_user_id ON user_feedback(user_id);
CREATE INDEX IF NOT EXISTS idx_report_ratings_user_id ON report_ratings(user_id);
CREATE INDEX IF NOT EXISTS idx_report_ratings_report_type ON report_ratings(report_type);
CREATE INDEX IF NOT EXISTS idx_system_metrics_category ON system_metrics(category, recorded_at);
CREATE INDEX IF NOT EXISTS idx_api_performance_endpoint ON api_performance_logs(endpoint, created_at);
CREATE INDEX IF NOT EXISTS idx_llm_usage_user_id ON llm_usage_logs(user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_cache_performance_type ON cache_performance(cache_type, created_at);
CREATE INDEX IF NOT EXISTS idx_search_analytics_query ON search_analytics(search_query, created_at);

-- Add foreign key constraint
ALTER TABLE admin_users ADD CONSTRAINT fk_admin_users_role_id 
