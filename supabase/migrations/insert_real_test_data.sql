...
BEGIN
    ...
    IF real_user_id IS NOT NULL THEN
        ...
        -- public.users 테이블에 사용자 정보 추가
        INSERT INTO public.users (id, email, name, created_at, updated_at, subscription_type, usage_limit, current_usage)
        VALUES (
            real_user_id,
            'test@example.com',
            'Test User',
