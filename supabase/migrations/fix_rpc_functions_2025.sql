...
-- 기존 함수들 삭제
DROP FUNCTION IF EXISTS update_user_balance(UUID);
DROP FUNCTION IF EXISTS get_expiring_points(UUID, INTEGER);
DROP FUNCTION IF EXISTS record_login_activity(UUID, TEXT, TEXT, TEXT, BOOLEAN);
DROP FUNCTION IF EXISTS record_user_activity(UUID, TEXT, TEXT, TEXT, TEXT, JSONB);
