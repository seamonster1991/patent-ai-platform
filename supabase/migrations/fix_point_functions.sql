...
DROP FUNCTION IF EXISTS charge_points(uuid,integer,text,text,text,timestamptz);
DROP FUNCTION IF EXISTS refund_points(uuid,integer,text,text);
DROP FUNCTION IF EXISTS calculate_point_balance(uuid);
DROP FUNCTION IF EXISTS add_points(uuid,integer,text,text);
