...
BEGIN
    ...
    IF real_user_id IS NOT NULL THEN
        ...
        -- AI 분석 보고서 데이터 생성 (public.users 참조)
        ...
        -- 사용량 비용 추적 데이터 생성 (auth.users 참조)
